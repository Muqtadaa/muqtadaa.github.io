...
// Explorer's "Title" on a JPEG fans out to XMP:Description, the IPTC caption,
// EXIF:ImageDescription and EXIF:XPTitle; Photoshop/Bridge write the XMP
// description; macOS Photos, Preview and Lightroom write the title as XMP
// dc:title; PNG text chunks are what dedicated tools write.
const CAPTION_TAGS = [
  'XMP:Description',
  'XMP:Title',
