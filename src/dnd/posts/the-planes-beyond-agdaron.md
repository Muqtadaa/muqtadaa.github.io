...
Asmodeus was a Prime Deity before he was a prisoner. He was cast down for siding
with the Primordials against mortal life, and he turned his sentence into a
throne.
...
- **1. Avernus** — Zariel. A barren waste of fiery pits and the damned, and
  ...
  forces loyal to Asmodeus.
- **2. Dis** — Dispater. A city of iron and fire, and the point at which Hell
  stops being a landscape and becomes an administration. Souls in ledgers, tolls
  between districts, True Names bound into infernal record. The dangerous devils
  here prefer signatures to swords.
- **3. Minauros** — Glasya. A vast rotting swamp, a twisted mockery of Melorah's
  domain, and Glasya is Melorah's dark reflection: an archdruid of spores, with
  poisons worked into the ground itself.
- **4. Phlegethos** — Geryon. A gloomy desert of jagged rock and searing
  sandstorms, whose ruler bends reality and whose landscape lies. Mirage cities,
  labyrinths of shifting dune, oases that poison the drinker.
- **5. Stygia** — Cimeries. A frozen city. The damned are set into the ice in
  poses matching their sins, and the lord of the layer can animate them.
- **6. Mulciberus** — Tiamat. A sea of fire hot enough to melt steel, crossed by
  burning ships. The damned burn in the lava, and can be raised as a shield.
- **7. Maladomini** — Andrealphus. A carnival of horrors: rides built to torment,
  performers set to guard them, and a ringmaster who would rather turn a party
  against itself than fight it.
- **8. Cocytus** — An underground mine of precious metals and gems, worked by
  demonic miners and deadly machinery. Its devil lord was not born to the title.
  He bought it with a soul that was not his to sell.
- **9. Nessus** — Asmodeus. The bottom. Towering infernos, rivers of lava, and
  the throne. Asmodeus made the Hellfire Crown and the Retributive Soul Engine,
  and he holds Malyr, God of Battle, prisoner here.

The rest of the cosmology exists, and the party has brushed most of it in
passing: the Shadowfell, the Elemental Planes where the surviving Primordials
were bound, the Abyss, Limbo, Arvandor and the House of Nature.
